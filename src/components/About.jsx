...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row gap-2 items-center justify-center bg-gray-100 p-4 h-screen">
      ...
      <h1 className="text-4xl md:text-6xl font-bold text-white animate-bounce animate-colorChange">
        QuizG
      </h1>
    </div>
  );
